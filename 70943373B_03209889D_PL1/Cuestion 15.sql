...
ON estudiantes2 USING HASH (estudiante_id);
...
SELECT
    pg_size_pretty(pg_relation_size('idx_estudiantes2_id_hash')) AS tamaño,
...
SELECT *
FROM hash_metapage_info(get_raw_page('idx_estudiantes2_id_hash', 0));
